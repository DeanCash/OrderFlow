        ...
        private void AddSeeders(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Consumable>()
                .HasData(
                    ...
                    // custom
                    new Consumable { Id = 1, Name = "Apple", Description = "Fresh and juicy apple", Price = 1.1m, ImagePath = "apple.png", Type = ConsumableType.Voorgerechten },
                    new Consumable { Id = 2, Name = "Pizza", Description = "Delicious cheesy pizza", Price = 5.15m, ImagePath = "pizza.png", Type = ConsumableType.Hoofdgerechten },
                    new Consumable { Id = 3, Name = "Sandwich", Description = "Classic sandwich with ham and cheese", Price = 4.3m, ImagePath = "sandwich.png", Type = ConsumableType.Voorgerechten},
                    new Consumable { Id = 4, Name = "Croissant", Description = "Buttery and flaky croissant", Price = 2m, ImagePath = "croissant.png", Type = ConsumableType.Voorgerechten },
                    new Consumable { Id = 5, Name = "Pasta", Description = "Classic pasta with marinara sauce", Price = 9.3m, ImagePath = "pasta.png", Type = ConsumableType.Hoofdgerechten },
                    new Consumable { Id = 6, Name = "Burger", Description = "Juicy beef burger with cheese", Price = 4.4m, ImagePath = "burger.png", Type = ConsumableType.Hoofdgerechten },

                    new Consumable { Id = 7, Name = "Orange Juice", Description = "Refreshing orange juice", Price = 2m, ImagePath = "orange-juice.jpg", Type = ConsumableType.Frisdranken },
                    new Consumable { Id = 8, Name = "Cola", Description = "Carbonated cola drink", Price = 1.4m, ImagePath = "cola.png", Type = ConsumableType.Frisdranken },
                    new Consumable { Id = 9, Name = "Iced Tea", Description = "Refreshing iced tea", Price = 2m, ImagePath = "icedtea.png", Type = ConsumableType.Frisdranken },
                    new Consumable { Id = 10, Name = "Lemonade", Description = "Homemade lemonade", Price = 3m, ImagePath = "lemonade.png", Type = ConsumableType.Frisdranken },
                    new Consumable { Id = 11, Name = "Coffee", Description = "Rich and aromatic coffee", Price = 3.1m, ImagePath = "coffee.jpg", Type = ConsumableType.Koffie },
                    new Consumable { Id = 12, Name = "Milkshake", Description = "Creamy milkshake", Price = 4m, ImagePath = "milkshake.png", Type = ConsumableType.Frisdranken }
                )
            ;
